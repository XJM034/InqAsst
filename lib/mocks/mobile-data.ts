  ...
  groups: [
    {
      ...
      label: "5年级3班",
      students: [
        { id: "absent-01", name: "李景行", course: "乐高竞赛班5-6", status: "absent" },
        { id: "absent-02", name: "张明轩", course: "足球 U8班", status: "absent" },
        { id: "absent-03", name: "陈思远", course: "创意美术A班", status: "absent" },
      ],
    },
    {
      id: "group-6-1",
      label: "6年级1班",
      students: [
        { id: "absent-04", name: "王子涵", course: "乐高竞赛班5-6", status: "absent" },
        { id: "absent-05", name: "刘雨桐", course: "足球 U8班", status: "absent" },
        { id: "absent-06", name: "赵思琪", course: "创意美术A班", status: "absent" },
      ],
    },
  ],
};
